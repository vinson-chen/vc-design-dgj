...
export interface VOperationBarProps {
...
export type OperationBarProps = VOperationBarProps;

/**
 * 通用操作区（operation_bar）：左右两侧插槽，space-between 对齐。
 * 结构对齐 Figma `operation_bar`：48 高、左右 16px padding、内容 32px 高并垂直居中。
 */
export default function VOperationBar({ left, right, sticky = false, className, style }: VOperationBarProps) {
  return (
    <div
      className={className}
      style={{
