...
export interface TopOperationBarProps {
  /** 搜索框占位文案，默认「请输入」 */
  ...
  /** 透传给 OverflowActions 的其它配置（除 items） */
  overflowActionsProps?: Omit<OverflowActionsProps, 'items'>;
}
      ...
      <OperationBar
        ...
        right={
          <div style={{ minWidth: 0, width: '100%' }}>
            <OverflowActions items={items} iconOnlyMore {...overflowActionsProps} />
          </div>
        }
      />
    </div>
