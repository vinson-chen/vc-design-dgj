...
import './VFilterGroup.css';

export type VFilterFieldType = 'input' | 'select' | 'datePicker';
/** @deprecated Use VFilterFieldType instead */
export type FilterFieldType = VFilterFieldType;

export interface VFilterFieldConfig {
  key: string;
  type: VFilterFieldType;
  placeholder?: string;
  options?: { label: string; value: string }[];
  allowClear?: boolean;
}
/** @deprecated Use VFilterFieldConfig instead */
export type FilterFieldConfig = VFilterFieldConfig;

export interface VFilterGroupProps {
  fields: VFilterFieldConfig[];
...
/** @deprecated Use VFilterGroupProps instead */
export type FilterGroupProps = VFilterGroupProps;
 ...
 */
export default function VFilterGroup({
  fields,
  value,
  onChange,
  onSearch,
