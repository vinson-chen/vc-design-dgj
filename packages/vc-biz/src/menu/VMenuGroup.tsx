...
import VMenuItem, { type VMenuItemAlign } from './VMenuItem';
import { figmaMenuIconNames, resolveMenuIconFromFigma } from './figmaIconResolver';

export interface VMenuGroupItem {
  key: string;
  label: string;
  iconName?: string;
}
/** @deprecated Use VMenuGroupItem instead */
export type BizMenuGroupItem = VMenuGroupItem;
...
/** @deprecated Use VMenuGroupProps instead */
export type BizMenuGroupProps = VMenuGroupProps;

export default function VMenuGroup({
  title,
  items = [],
  ...
  const align: VMenuItemAlign = small ? 'center' : 'left';
