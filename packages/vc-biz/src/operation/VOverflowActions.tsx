...
export interface VOverflowActionItem {
  key: string;
  label: string;
  icon: string;
...
/** @deprecated Use VOverflowActionItem instead */
export type OverflowActionItem = VOverflowActionItem;

export interface VOverflowActionsProps {
...
/** @deprecated Use VOverflowActionsProps instead */
export type OverflowActionsProps = VOverflowActionsProps;
...
export default function VOverflowActions({
  items,
  menuOnlyItems = [],
  maxVisibleWithMore,
  iconOnlyMore = true,
