...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    category: '业务组件',
    items: [
      { key: 'vmenu', label: 'VMenu 导航区' },
      { key: 'vfilter-area', label: 'VFilterArea 筛选区' },
      { key: 'vtabs', label: 'VTabs 切换区' },
      { key: 'voperation-bar', label: 'VOperationBar 操作区' },
      { key: 'vtable', label: 'VTable 表格区' },
